...
const ChangeArrow = (props) => {
  ...
  const [DiskImageDisplayed, setDiskImageDisplayed] = useState(
    "abourWork-image aboutWork-imageHide"
  );
  ...
  if (
    !params.inicio &&
    where === "work" &&
    DiskImageDisplayed === "aboutWork-image"
  ) {
  ...
  if (
    !params.inicio &&
    where === "work" &&
    DiskImageDisplayed === "aboutWork-imageHide"
  ) {
    setDiskImageDisplayed("aboutWork-image aboutWork-image-rotate");
    setToWorkClick("toWorkArrow");
    setClicked("nextArrow nextArrowClicked");
  ...
  if (
    !params.inicio &&
    where === "aboutme" &&
    DiskImageDisplayed === "aboutWork-image aboutWork-image-rotate"
  ) {
    setDiskImageDisplayed("aboutWork-image");
    setToWorkClick("toWorkArrow");
  }
  ...
  if (
    where === "photo-areas" &&
    clicked === "nextArrow nextArrowClickedWorkAreas"
  ) {
    setClicked("nextArrow nextArrowClickedTop");
    setToWorkClick("toWorkArrowHide");
    setDiskImageDisplayed("aboutWork-imageHide");
  ...
  if (
    where === "photo-product" &&
    (clicked === "nextArrow nextArrowClicked" ||
      clicked === "nextArrow nextArrowClickedWorkAreas")
  ) {
    setClicked("nextArrow nextArrowClickedTop ");
    setToWorkClick("toWorkArrowHide");
  ...
  return (
    <div>
      ...
      >
        <div className="nextArrowImage"></div>
        <button
          onClick={() => {
            if (clicked === "nextArrow nextArrowClicked") {
              ...
              if (!params.incio) {
                if (
                  toWorkClick === "toWorkArrow" &&
                  DiskImageDisplayed ===
                    "aboutWork-image aboutWork-image-rotate"
                ) {
                  navigate("/aboutme");
                  setWhere("aboutme");
                } else {
              ...
              if (where === "work-areas") {
                ...
                setClicked("nextArrow nextArrowClicked");
                setToWorkClick("toWorkArrow");
                setDiskImageDisplayed(
                  "aboutWork-image about-Work-image-rotateback"
                );
                navigate("/aboutme");
                setWhere("aboutme");
              }
      ...
      <div className={DiskImageDisplayed}>
        <img
          src={require("../../../assets/images/sobremi-imagen.png")}
          alt="Animación"
        />
      </div>
    </div>
