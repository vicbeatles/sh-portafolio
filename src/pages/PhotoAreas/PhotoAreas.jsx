...
const PhotoAreas = (props) => {
  ...
  return (
    <div class='photoa-container'><div class='product-area'><button onClick={()=> {navigate('/mywork/areas/photo/product')}}><svg width="298" height="457" viewBox="0 0 298 457" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class='area-title'>PRODUCTO</div>
    </div>
    <div class='doc-area'><button onClick={()=> {navigate('/mywork/areas/photo/documental')}}><svg width="421" height="485" viewBox="0 0 421 485" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<stop class='doccolor2' offset="1" stop-color="#0D0101"/>
    ...
    <div class='area-title'>DOCUMENTAL</div>
    </div>
    </div>
  )
}
