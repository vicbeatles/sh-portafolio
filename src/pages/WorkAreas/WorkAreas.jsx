...
<stop  class='photocolor1' stop-color="#00F7CA"/>
<stop class='photocolor2' offset="1" stop-color="#1D58F2"/>
</linearGradient>
...
<div class='area-title'>FOTOGRAFIA</div>
</div>
        <div class='design-area'><svg width="186" height="192" viewBox="0 0 186 192" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<stop class='designcolor1' stop-color="#10FFB7"/>
<stop class='designcolor2' offset="1" stop-color="#FFF500"/>
</linearGradient>
...
<div class='area-title'>DISEÑO</div>
</div>
        <div class='three-area'><svg width="322" height="339" viewBox="0 0 322 339" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<stop class='threecolor1' offset="0.0001" stop-color="#5200FF"/>
<stop class='threecolor2' offset="1" stop-color="#D9035D"/>
</linearGradient>
...
<div class='area-title'>3D</div>
</div>
        <div class='ux-area'><svg width="332" height="398" viewBox="0 0 332 398" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<stop class='uxcolor1' stop-color="#BF08FF"/>
<stop class='uxcolor2' offset="1" stop-color="#24FF00" stop-opacity="0.37"/>
</linearGradient>
