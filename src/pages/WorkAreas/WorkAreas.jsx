...
const navigate = useNavigate();
  ...
  return (
    <div className="workareas-container">
        <div className={!transition ? 'photo-area' : 'photo-area photo-area-t'}><button className='photo-area-button' onClick={()=> {
...
<div className='area-title-workareas'>FOTOGRAFIA</div>
        ...
        <div className={!transition ? 'design-area' : 'design-area design-area-t'}><button className='design-area-button' onClick={()=> {
...
<div className='area-title-workareas'>DISEÑO</div>
        ...
        <div className={!transition ? 'three-area' : 'three-area three-area-t'}><button className='three-area-button' onClick={()=>{navigate('/mywork/areas/threedim')}}><svg width="322" height="339" viewBox="0 0 322 339" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div className='area-title-workareas'>3D</div>
        ...
        <div className={!transition ? 'ux-area' : 'ux-area ux-area-t'}><button className='ux-area-button' onClick={()=> {navigate('/mywork/areas/ux')}}><svg width="332" height="398" viewBox="0 0 332 398" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div className={!transition ? 'contact-area' : 'contact-area contact-area-t'}><button className='contact-area-button' onClick={()=> {navigate('/mywork/areas/contact')}}>Contactos</button></div>
